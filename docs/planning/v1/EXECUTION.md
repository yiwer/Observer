...
- 当前实施票：#8，**可版本化兴趣配置与全球覆盖底线**。原生依赖 #7 已 CLOSED，基线包含其最终集成与验收；fresh-context `/root/implement_v1_08`，worktree `O:/GenesisCode/Observer-worktrees/v1-08`、branch `ticket/v1-08`、fixed base **b1b6ac3ab557f0098ae5b133f20f4ca32b9182aa**。方案已确认属原 T1；首片文件导入/快照/排序 **0/1 RED→1/1 GREEN**、typecheck PASS。Root WIP独立“第9候选进入前7” **1/1**，旧Record1/2/3/两期4共 **5/5**兼容。作者继续版本无效回退、在途快照、baseline和覆盖等后续竖切；尚未冻结，诊断不替代完整验收。见 [#8执行记录](acceptance/08-explicit-interest-and-global-coverage.md)。
