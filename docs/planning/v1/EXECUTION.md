...
- 当前实施票：#8，**可版本化兴趣配置与全球覆盖底线**。原生依赖 #7 已 CLOSED；fresh-context `/root/implement_v1_08`，branch `ticket/v1-08`，fixed base **b1b6ac3ab557f0098ae5b133f20f4ca32b9182aa**。首次冻结 **c0a4522ca52704f2f6c5ae65ca970ae3a0429214**（14 files、+792/-29）不接受：Standards 0 hard / 2非阻断P3，Spec **1 P2**（准备核验的材料被误称实际发送）；Root独立built专项 **2PASS/2RED**复现。作者首轮full **165/166 FAIL**，唯一失败为既有Docker tag查询；无第二full/smoke。Root其它built专项容量/覆盖2/2、历史14/14、旧归档5/5通过，不能掩盖P2。已交原作者窄范围TDD修复，待新SHA重新验收；尚未集成/关闭，不启动#9。见 [#8执行记录](acceptance/08-explicit-interest-and-global-coverage.md)。
