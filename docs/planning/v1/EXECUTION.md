...
- 当前实施票：#10，**合规社交样本到话语观察Edition**。固定base **f36aae2122d081e638bfd520f93ded88fc95ef3b**；新worktree `O:/GenesisCode/Observer-worktrees/v1-10` / branch `ticket/v1-10` 已核对clean，fresh `/root/implement_v1_10` 已派发。原生唯一依赖#7 CLOSED且集成可达；#10 OPEN / yiwer、[启动回写](https://github.com/yiwer/Observer/issues/10#issuecomment-5555149060)已实际读回。先固定采样/权限/两类观察/版本和首片方案；无本票测试或验收PASS。见[#10记录](acceptance/10-social-discourse-edition.md)。
