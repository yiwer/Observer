...
export const SourcePolicySchema = z.strictObject({
  ...
  github: z.strictObject({ allowedQueries: z.array(z.string().min(1).max(200)).min(1).max(3), allowApiResponseProcessing: z.boolean(),
    ...
    events: z.strictObject({ schemaVersion: z.literal(1), allowReleaseMetadata: z.boolean(), allowAdvisoryMetadata: z.boolean(),
      allowReleaseBodyProcessing: z.boolean(), allowMaterialityModelProcessing: z.boolean(), allowMaterialEvidenceProjection: z.boolean(), allowEventIdentityHistory: z.boolean(),
      allowAdvisoryBodyProcessing: z.boolean().optional(), allowMomentumEvidence: z.boolean().optional() }).optional(),
  }).optional(),
