...
export const EventClusterSchema = z.strictObject({
  ...
  developments: z.array(z.strictObject({ id, storyId: id, claimId: id, disclosure: eventTime, materialityClaimIds: z.array(id),
    coverage: z.enum(["current-disclosure", "late-discovered", "previously-covered", "not-material", "unknown-disclosure"]),
  })).min(1),
