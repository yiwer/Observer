...
export async function prepareDiscourse(input: { request: Extract<SixEditionRequest, { schemaVersion: 6 | 7 }>; configuration: DiscourseConfiguration; frozenAtUtc: string;
